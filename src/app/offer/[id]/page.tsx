          ...
          <div className="border-t pt-6">
            ...
            <div className="flex flex-wrap gap-4">
              {business.whatsappLink && (
                <a
                  href={`${business.whatsappLink}?text=Hi! I'm interested in your offer: "${offer.title}" from ${business.name}. Can you provide more details?`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center shadow-lg"
                >
